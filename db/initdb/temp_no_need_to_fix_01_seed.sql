...
((SELECT id FROM words WHERE word = 'een' AND part_of_speech = 'numeral' LIMIT 1), 1, 'eerste'),
((SELECT id FROM words WHERE word = 'twee' AND part_of_speech = 'numeral' LIMIT 1), 2, 'tweede'),
((SELECT id FROM words WHERE word = 'drie' AND part_of_speech = 'numeral' LIMIT 1), 3, 'derde'),
((SELECT id FROM words WHERE word = 'vier' AND part_of_speech = 'numeral' LIMIT 1), 4, 'vierde'),
((SELECT id FROM words WHERE word = 'vijf' AND part_of_speech = 'numeral' LIMIT 1), 5, 'vijfde'),
((SELECT id FROM words WHERE word = 'zes' AND part_of_speech = 'numeral' LIMIT 1), 6, 'zesde'),
((SELECT id FROM words WHERE word = 'zeven' AND part_of_speech = 'numeral' LIMIT 1), 7, 'zevende'),
((SELECT id FROM words WHERE word = 'acht' AND part_of_speech = 'numeral' LIMIT 1), 8, 'achtste'),
((SELECT id FROM words WHERE word = 'negen' AND part_of_speech = 'numeral' LIMIT 1), 9, 'negende'),
((SELECT id FROM words WHERE word = 'tien' AND part_of_speech = 'numeral' LIMIT 1), 10, 'tiende'),
((SELECT id FROM words WHERE word = 'elf' AND part_of_speech = 'numeral' LIMIT 1), 11, 'elfde'),
((SELECT id FROM words WHERE word = 'twaalf' AND part_of_speech = 'numeral' LIMIT 1), 12, 'twaalfde'),
((SELECT id FROM words WHERE word = 'dertien' AND part_of_speech = 'numeral' LIMIT 1), 13, 'dertiende'),
((SELECT id FROM words WHERE word = 'veertien' AND part_of_speech = 'numeral' LIMIT 1), 14, 'veertiende'),
((SELECT id FROM words WHERE word = 'vijftien' AND part_of_speech = 'numeral' LIMIT 1), 15, 'vijftiende'),
((SELECT id FROM words WHERE word = 'zestien' AND part_of_speech = 'numeral' LIMIT 1), 16, 'zestiende'),
((SELECT id FROM words WHERE word = 'zeventien' AND part_of_speech = 'numeral' LIMIT 1), 17, 'zeventiende'),
((SELECT id FROM words WHERE word = 'achttien' AND part_of_speech = 'numeral' LIMIT 1), 18, 'achttiende'),
((SELECT id FROM words WHERE word = 'negentien' AND part_of_speech = 'numeral' LIMIT 1), 19, 'negentiende'),
((SELECT id FROM words WHERE word = 'twintig' AND part_of_speech = 'numeral' LIMIT 1), 20, 'twintigste'),
((SELECT id FROM words WHERE word = 'dertig' AND part_of_speech = 'numeral' LIMIT 1), 30, 'dertigste'),
((SELECT id FROM words WHERE word = 'veertig' AND part_of_speech = 'numeral' LIMIT 1), 40, 'veertigste'),
((SELECT id FROM words WHERE word = 'vijftig' AND part_of_speech = 'numeral' LIMIT 1), 50, 'vijftigste'),
((SELECT id FROM words WHERE word = 'honderd' AND part_of_speech = 'numeral' LIMIT 1), 100, 'honderdste'),
((SELECT id FROM words WHERE word = 'duizend' AND part_of_speech = 'numeral' LIMIT 1), 1000, 'duizendste'),
((SELECT id FROM words WHERE word = 'achthonderdzesentwintig' AND part_of_speech = 'numeral' LIMIT 1), 84, 'achthonderdzesentwintigste'),
((SELECT id FROM words WHERE word = 'vierentachtig' AND part_of_speech = 'numeral' LIMIT 1), 84, 'vierentachtigste'),
((SELECT id FROM words WHERE word = 'vierentwintig' AND part_of_speech = 'numeral' LIMIT 1), 24, 'vierentwintigste'),
((SELECT id FROM words WHERE word = 'zeshonderd' AND part_of_speech = 'numeral' LIMIT 1), 600, 'zeshonderdste'),
((SELECT id FROM words WHERE word = 'zevenhonderdnegenennegentig' AND part_of_speech = 'numeral' LIMIT 1), 799, 'zevenhonderdnegenennegentigste')
ON CONFLICT (word_id) DO NOTHING;
